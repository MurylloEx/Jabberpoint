...
public class MadisonTemplate implements ITemplate{

  @Getter
  private Style[] styles;

  public MadisonTemplate(){
    this.styles = new Style[] {
      new Style(0,  Color.green,  48, 20), //Nível 0
      new Style(20, Color.green,  40, 10), //Nível 1
      new Style(50, Color.orange, 36, 10), //Nível 2
      new Style(70, Color.yellow, 30, 10), //Nível 3
